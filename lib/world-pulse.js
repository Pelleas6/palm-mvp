...
const RSS_FETCH_CONCURRENCY = 12;
...
const DEFAULT_RSS_FEEDS = [
  ...
  { name: "Radio Dabanga", region: "Africa", url: "https://www.dabangasudan.org/en/feed/", language: "English", sourceCountry: "Sudan" },
  ...
  // on limite les nouvelles entrées pour privilégier la diversité des médias
  // plutôt qu'un volume qui rendrait la carte et la localisation moins lisibles.
  { name: "Jerusalem Post", region: "Middle East", url: "https://rss.jpost.com/rss/rssfeedsfrontpage.aspx", language: "English", sourceCountry: "Israel", maxItems: 14 },
  { name: "Israel National News", region: "Middle East", url: "https://www.israelnationalnews.com/Rss.aspx?act=.1", language: "English", sourceCountry: "Israel", maxItems: 14 },
  { name: "IRNA English", region: "Middle East", url: "https://en.irna.ir/rss", language: "English", sourceCountry: "Iran" },
  { name: "Dawn", region: "Asia", url: "https://www.dawn.com/feeds/home", language: "English", sourceCountry: "Pakistan" },
  { name: "The Wire", region: "Asia", url: "https://thewire.in/rss", language: "English", sourceCountry: "India", maxItems: 14 },
  { name: "Scroll.in", region: "Asia", url: "https://scroll.in/rss", language: "English", sourceCountry: "India", maxItems: 14 },
  { name: "The Print", region: "Asia", url: "https://theprint.in/feed/", language: "English", sourceCountry: "India", maxItems: 14 },
  { name: "Hindustan Times", region: "Asia", url: "https://www.hindustantimes.com/rss/top-news/rssfeed.xml", language: "English", sourceCountry: "India", maxItems: 14 },
  { name: "Moneycontrol", region: "Asia", url: "https://www.moneycontrol.com/rss/latestnews.xml", language: "English", sourceCountry: "India", maxItems: 14 },
...
async function fetchWebNgramsTocAttempt({ fetchImpl, timeoutMs, referenceDate, ngramsCache }) {
  ...
  try {
    ...
    return {
      ok: false,
      trends: emptyWebNgramsTrends({ timestamp, url, checkedAt, state: error?.name === "AbortError" ? "TIMEOUT" : "HTTP_ERROR", error: fetchError }),
      error: fetchError,
      health: buildSourceHealth({ source: "GDELT Web N-Grams TOC", region: "Global trends", url, http: "ERR", state: error?.name === "AbortError" ? "TIMEOUT" : "HTTP_ERROR", detail: described.detail, checkedAt }),
    };
  }
}
