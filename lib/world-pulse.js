...
const DEFAULT_RSS_FEEDS = [
  ...
  { name: "The Times of Israel", region: "Middle East", url: "https://www.timesofisrael.com/feed/", language: "English", sourceCountry: "Israel" },
  ...
  for (const bucket of buckets.values()) {
    ...
    for (const cluster of localClusters.filter((item) => item.entries.length > 1)) {
      ...
      clusters.push({
        ...
        // Le diamètre est un encodage de volume : une bulle de 6 articles doit
        // rester visiblement plus large qu'une bulle de 2, même sur une carte dense.
        size: clamp(Math.round(13 + Math.sqrt(entries.length) * 6), 20, 38),
