...
export function buildSystemPrompt() {
  return `Tu es un expert en morphologie de la main. À partir de cette photo, produis une analyse des plis palmaires et des reliefs musculaires visibles. Décris objectivement ce que tu observes.
