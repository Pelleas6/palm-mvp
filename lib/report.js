...
Main non-dominante = potentiel inné. Main dominante = ce qui a été développé. Convergences ou divergences.
...
Lignes principales :
- Ligne de vie : longueur, profondeur, clarté, interruptions, bifurcations
- Ligne de cœur : longueur, courbure, terminaison, accidents
- Ligne de tête : droite ou incurvée ? liée ou séparée de la ligne de vie ?
- Ligne de chance / Saturne : présence, clarté, origine, terminaison

Lignes secondaires si visibles : Ligne du Soleil, Ceinture de Vénus, Rascettes

Monts : Vénus, Jupiter, Saturne, Soleil, Mercure, Lune

Signes notables si visibles : étoile, île, carré, fourche, chaîne
  ...
  const resp = await openai.chat.completions.create({
    ...
    messages: [
      { role: "system", content: buildSystemPrompt() },
      {
        role: "user",
        content: [
          { type: "text",      text: buildUserPrompt(prenom, dateNaissance, themeChoisi) },
