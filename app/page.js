...
export default function Home() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // ── ÉTAPE 1 : Demander les signed URLs à Supabase via notre API ──
      ...
      // ── ÉTAPE 2 : Upload direct des fichiers vers Supabase (bypass Vercel) ──
      ...
      if (!leftPut.ok || !rightPut.ok) {
        throw new Error(
          "Erreur upload Supabase — left:" + leftPut.status + " right:" + rightPut.status
        );
      }

      // ── ÉTAPE 3 : Lancer l'analyse (IA + emails) ──
  ...
  return (
    <div style={{ backgroundColor: theme.bg, minHeight: "100vh", fontFamily: "Georgia, serif" }}>
      ...
      <section
        ...
        style={{
          maxWidth: 1100, margin: "0 auto", padding: "64px 40px",
      ...
      >
        ...
        <div style={{ minWidth: 0, overflowWrap: "break-word" }}>
          ...
          <h1 style={{ fontSize: 44, fontWeight: 700, color: theme.text, lineHeight: 1.2, margin: "0 0 18px" }}>
          ...
          <div id="comment" style={{ marginTop: 10 }}>
            <div style={{ textAlign: "left", marginBottom: 22 }}>
              <div style={{ fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: theme.gold, marginBottom: 10 }}>
            ...
            <div style={{ position: "relative", paddingLeft: 36, display: "flex", flexDirection: "column", gap: 22 }}>
              <div style={{
                ...
                width: 1, backgroundColor: theme.gold, opacity: 0.5,
              }} />
              {[
                { n: 1, title: "Renseignez vos informations", text: "Votre prénom, votre date de naissance et le thème qui vous guide. Cela oriente l'analyse avec justesse." },
                { n: 2, title: "Ajoutez les photos des deux mains", text: "Paume ouverte, lumière naturelle, lignes nettes. Chaque détail compte." },
                ...
                <div key={step.n} className="softShadow2" style={{
                  position: "relative", backgroundColor: theme.card,
                  padding: "20px 22px", borderRadius: 14, border: `1px solid ${theme.border}`,
                }}>
                  <div style={{
                    position: "absolute", left: -36, top: 22,
                    width: 28, height: 28, borderRadius: "50%",
                    border: `1.5px solid ${theme.gold}`, backgroundColor: theme.bg,
                    display: "flex", alignItems: "center", justifyContent: "center",
                    fontSize: 12, color: theme.gold, fontWeight: 600,
                  }}>
                    {step.n}
                  </div>
        ...
        <div
          ...
          style={{
            ...
            border: `1px solid ${theme.border}`, padding: "28px 24px",
        ...
        >
          ...
          <div style={{
            backgroundColor: theme.goldLight, borderRadius: 12,
            padding: "12px 14px", marginBottom: 18, border: `1px solid ${theme.border}`,
          }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 6, fontSize: 12, color: theme.text }}>
              {[
                { label: "Délai", value: "Sous 24h" },
                { label: "Confidentialité", value: "Photos supprimées" },
                { label: "Lecture", value: "Personnalisée" },
              ].map(({ label, value }) => (
          ...
          <form onSubmit={handleSubmit}>
            <div className="nameGrid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 12 }}>
              <div>
                ...
                <input className="focusable" type="text" value={prenom} placeholder="Marie" style={inputStyle}
                  onChange={(e) => { setPrenom(e.target.value); setResult(null); setError(null); }} />
              </div>
              <div>
                <div style={labelStyle}>Nom</div>
                <input className="focusable" type="text" value={nom} placeholder="Dupont" style={inputStyle}
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <input className="focusable" type="email" value={email} placeholder="votre@email.com" style={inputStyle}
                onChange={(e) => { setEmail(e.target.value); setResult(null); setError(null); }} />
            </div>

            <div style={{ marginBottom: 16 }}>
              <div style={labelStyle}>Date de naissance</div>
              <input className="focusable" type="date" value={dateNaissance} style={inputStyle}
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginTop: 6 }}>
                {[
                  ...
                  <label key={side} className="focusable" style={{
                    display: "flex", flexDirection: "column",
                    alignItems: "center", justifyContent: "center",
                    padding: 10, borderRadius: 12,
                    border: `2px dashed ${file ? theme.sage : theme.border}`,
                    backgroundColor: file ? theme.sageLight : theme.bg,
            ...
            <button type="submit" disabled={!canSubmit} className="focusable" style={{
              ...
              letterSpacing: "0.03em", transition: "background-color 0.2s",
            }}>
      ...
      {result === "MAIL_CONFIRMATION" && (
        <section style={{ maxWidth: 760, margin: "40px auto", padding: "0 40px 60px" }}>
          <div className="softShadow2" style={{
            backgroundColor: theme.card, borderRadius: 16,
            border: `1px solid ${theme.border}`, padding: "32px 28px",
          }}>
            <div style={{
              display: "flex", alignItems: "center", gap: 10,
              marginBottom: 18, paddingBottom: 14, borderBottom: `1px solid ${theme.border}`,
            }}>
            ...
            <div style={{ fontSize: 14, lineHeight: 1.85, color: theme.text }}>
              ...
              <p>Après analyse de vos deux mains, votre rapport personnalisé vous sera adressé par email sous 24h (hors dimanche).</p>
      ...
      <footer style={{ borderTop: `1px solid ${theme.border}`, backgroundColor: theme.card, padding: "56px 40px 0" }}>
        <div className="footerGrid" style={{
          ...
          <div>
            ...
            {seoPages.map((l) => (
              <a key={l.label} href={l.href} className="focusable" style={{ fontSize: 13, color: theme.textLight, marginBottom: 10, textDecoration: "none", display: "block" }}>
                {l.label}
              </a>
            ))}
          </div>
        ...
        <div style={{
          maxWidth: 1000, margin: "0 auto", borderTop: `1px solid ${theme.border}`,
